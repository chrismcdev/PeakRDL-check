...
$B --fixture 1k,10k,100k --tools peakrdl-check,peakrdl-html --runs 3 --timeout 1800

echo "=== 400k: both tools, 3 runs ==="
$B --fixture 400k --tools peakrdl-check --runs 3 --timeout 1800
$B --fixture 400k --tools peakrdl-html --runs 3 --timeout 1800

echo "=== 800k: peakrdl-check 3 runs ==="
$B --fixture 800k --tools peakrdl-check --runs 3 --timeout 1800
...
for mode in none registers all; do
  $B --fixture 100k --tools peakrdl-check --runs 3 --source-mode $mode
done

echo "=== unique-register profile (10k), both tools ==="
$B --fixture uniq10k --tools peakrdl-check,peakrdl-html --runs 3 --timeout 1800

echo "=== interactive query benchmarks (indexes from the matrix runs) ==="
$Q "$ROOT/benchmarks/out/bench-peakrdl-check-100k" 100k 200
$Q "$ROOT/benchmarks/out/bench-peakrdl-check-400k" 400k 200
$Q "$ROOT/benchmarks/out/bench-peakrdl-check-800k" 800k 200
